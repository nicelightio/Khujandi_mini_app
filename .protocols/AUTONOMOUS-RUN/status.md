...
- Note: no selectable `ready` or `in_progress` tasks remain; manual follow-up `TASK-FT007-09` mounted the admin auth HTTP boundary into the checked-in dev runtime and cleared the prior `FT-007` runtime blocker.
