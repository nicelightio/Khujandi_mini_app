---
description: Роутер по practical how-to guides проекта.
status: active
---
# Guides Index

- [.memory-bank/guides/prd-bootstrap-next-steps.md](prd-bootstrap-next-steps.md): Что делать после завершения `/prd` without speculative task generation.
- [.memory-bank/guides/slice-implementation-playbook.md](slice-implementation-playbook.md): HOW-гайд по раскладке кода по slices и shared extraction.
