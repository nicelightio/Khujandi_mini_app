...
- [.memory-bank/bugs/BUG-2026-04-06-ft007-admin-auth-handler-not-mounted-in-runtime.md](BUG-2026-04-06-ft007-admin-auth-handler-not-mounted-in-runtime.md): активный semantic bug по тому, что новый admin auth handler не смонтирован в реальный checked-in runtime entrypoint.
