...
- [.memory-bank/bugs/BUG-2026-04-02-task-ft009-06-missing-telegram-client-matrix-evidence.md](BUG-2026-04-02-task-ft009-06-missing-telegram-client-matrix-evidence.md): активный bug по отсутствующему real `Android Telegram` evidence для финального closure `FT-009`.
