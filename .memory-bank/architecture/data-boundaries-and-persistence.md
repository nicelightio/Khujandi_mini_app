...
- `catalog`: `shops`, shop description/media/status, menu pages, products, product description/media, seller ownership rules, seller Telegram binding read-model needs, and public visibility rules.
