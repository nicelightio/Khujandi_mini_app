...
- Cross-contour shared код не должен разрушать contour boundaries: contour-specific presentation code и runtime policy остаются в owning contour либо в его explicit shared technical layer.
